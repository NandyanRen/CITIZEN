      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/first_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/second_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/third_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/fourth_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/fifth_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/sixth_floor_directory.png";
        hideThumbnails();
      ...
      {
        showFloorImage();
        document.getElementById('floor-layout-image').src="images/seventh_floor_directory.png";
        hideThumbnails();
